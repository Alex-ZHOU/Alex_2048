...
public class HttpUtils {
    ...
    public static String post(final String urlString, final Map<String, String> params, final String encode) {
       ...
       final byte[] data = stringBuffer.toString().getBytes();//获得请求体
